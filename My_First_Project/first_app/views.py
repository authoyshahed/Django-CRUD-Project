...
def index(request):
    ...
    diction={'title':'This is index page','musician_list':musician_list}
...
def album_list(request,artist_id):
    ...
    diction={'title': 'This is album list', 'artist_info':artist_info,'album_list':album_list,'artist_rating':artist_rating}
...
def delete_album(request,album_id):
    ...
    diction={'delete_message':'Album Deleted Successfuly'}
...
def delete_musician(request,artist_id):
    ...
    diction={'delete_message':'Musician Deleted Successfuly'}
    return render(request, 'first_app/delete.html',context=diction)
